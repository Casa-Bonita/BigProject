...
//    - Сатурн, диаметр 25,2.
        ...
        while(!input.equals("9")){
            ...
            if (input.equals("1")){
                ...
                List<Planet1> planetList = crt.create1();
                Collections.sort(planetList);

                for(Planet1 pl : planetList){
                    System.out.printf("%-10s %-10s %n", pl.getName(), pl.getDiameter());
                }
                ...
                List<Planet2> planetList;
                planetList = crt.create2();
                Collections.sort(planetList);

                for(Planet2 pl : planetList){
                    System.out.printf("%-10s %-10s %n", pl.getName(), pl.getDiameter());
                }
                ...
                List<Planet3> planetList;
                planetList = crt.create3();
                Collections.sort(planetList);

                for(Planet3 pl : planetList){
                    System.out.printf("%-10s %-10s %n", pl.getName(), pl.getDiameter());
                }
                ...
                List<Planet4> planetList;
                planetList = crt.create4();
                Collections.sort(planetList);

                for(Planet4 pl : planetList){
                    System.out.printf("%-10s %-10s %n", pl.getName(), pl.getDiameter());
                }
                ...
                DiameterComparator dc = new DiameterComparator(1);
                ...
                DiameterComparator dc = new DiameterComparator(0);
                ...
                NameComparator nc = new NameComparator(1);
                ...
                NameComparator nc = new NameComparator(0);
